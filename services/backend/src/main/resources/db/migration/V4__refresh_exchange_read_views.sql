DROP VIEW IF EXISTS latest_market_rates_by_location;
DROP VIEW IF EXISTS due_rate_sources;
DROP VIEW IF EXISTS official_rates_with_source;
DROP VIEW IF EXISTS active_locations_with_institution;
DROP VIEW IF EXISTS active_currencies;
DROP VIEW IF EXISTS active_cities;
